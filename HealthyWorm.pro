...
contains(worm_NEED_QT_PLUGINS, 1) {
    DEFINES += worm_NEED_QT_PLUGINS
...
SOURCES += src/qt/worm.cpp src/qt/wormgui.cpp \
    ...
    src/qt/wormaddressvalidator.cpp \
    src/version.cpp \
    src/util.cpp \
    src/netbase.cpp \
    src/key.cpp \
    ...
    src/qt/wormstrings.cpp \
    src/qt/wormamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
QT += testlib
TARGET = worm-qt_test
DEFINES += worm_QT_TEST
}

CODECFORTR = UTF-8

# for lrelease/lupdate
# also add new translations to src/qt/worm.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/worm_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/worm-qt.rc
...
windows:RC_FILE = src/qt/res/worm-qt.rc
...
macx:ICON = src/qt/res/icons/HealthyWorm.icns
macx:TARGET = "HealthyWorm"
