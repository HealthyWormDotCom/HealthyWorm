...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 44500, uint256("0xc2efb153620eae6d338d1074d1ec01b25677261666dcb255ac3235f509abe1d6"))
        ;
    ...
    // HealthyWorm: synchronized checkpoint (centrally broadcasted)
    ...
    // HealthyWorm: get last synchronized checkpoint
    ...
    // HealthyWorm: only descendant of current sync-checkpoint is allowed
    ...
    // HealthyWorm: reset synchronized checkpoint to last hardened checkpoint
...
// HealthyWorm: sync-checkpoint master key
...
// HealthyWorm: verify signature of sync-checkpoint message
...
// HealthyWorm: process synchronized checkpoint
