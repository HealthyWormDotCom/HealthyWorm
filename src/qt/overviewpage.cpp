...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(wormUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = wormUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance)
{
    ...
    ui->labelStake->setText(wormUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(wormUnits::formatWithUnit(unit, unconfirmedBalance));
}
