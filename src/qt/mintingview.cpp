    ...
    QWidget(parent), model(0), mintingView(0)
{
    ...
    QLabel *youngLegend = new QLabel(tr("<font color=#111111>transaction is too young</font>"));
    ...
    QLabel *matureLegend = new QLabel(tr("<font color=#111111>transaction is mature</font>"));
    ...
    QLabel *oldLegend = new QLabel(tr("<font color=#111111>transaction  has reached maximum probability</font>"));
    ...
    QLabel *mintingLabel = new QLabel(tr("<font color=#111111>Display minting probability within : </font>"));
