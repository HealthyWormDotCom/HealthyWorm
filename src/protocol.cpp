...
// unsigned char pchMessageStartTestworm[4] = { 0xfa, 0xbf, 0xb5, 0xda };
...
// HealthyWorm message start (switch from worm's in v0.2)
static unsigned char pchMessageStartworm[4] = { 0x1a, 0x1b, 0x1c, 0x1d };
static unsigned char pchMessageStartHealthyWorm[4] = { 0x1c, 0x2d, 0x3a, 0x4b };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartHealthyWorm : pchMessageStartworm, sizeof(pchMessageStartHealthyWorm));
}
