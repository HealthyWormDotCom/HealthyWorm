...
#ifndef H_worm_SCRIPT
#define H_worm_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CwormAddress
 */
...
public:
    ...
    // Pre-version-0.6, worm always counted CHECKMULTISIGs
